...
export default function MatchCard({
    ...
    return (
        <div className={`bg-white rounded-2xl shadow-sm border p-5 card-hover ${isHighMatch ? 'border-emerald-200' : 'border-slate-200'
            }`}>
            ...
            <div className="flex justify-between items-start mb-4">
                ...
                <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl font-bold text-sm ${isHighMatch ? 'bg-emerald-100 text-emerald-700' :
            ...
            {/* Action */}
            <button className={`w-full py-2.5 rounded-xl font-bold transition-all duration-200 flex items-center justify-center gap-2 active:scale-95 ${isHighMatch
