...
export default function MatchCard({ 
  ...
  return (
    <div className={`bg-white rounded-2xl shadow-sm border p-5 transition-all hover:shadow-md ${
      isHighMatch ? 'border-emerald-200 bg-emerald-50/10' : 'border-slate-100'
    }`}>
      ...
      {/* Action */}
      <button className={`w-full py-2.5 rounded-xl font-bold transition flex items-center justify-center gap-2 ${
        isHighMatch 
