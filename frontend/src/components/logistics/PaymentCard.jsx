    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 flex flex-col h-full">
            <div className="flex justify-between items-start mb-6">
                ...
                <div className={`px-3 py-1 rounded-xl text-xs font-bold flex items-center gap-1.5 ${isReleased ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700 animate-pulse'
                    }`}>
