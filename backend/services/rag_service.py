...
COLLECTION_NAMES = [
    "crop_knowledge",      # crop info, schemes, government rules, weather patterns, logistics
    "reflection_memory",  # strategy outcomes, reflection memory, trust profiles
    "market_prices",      # historical prices, past deals
